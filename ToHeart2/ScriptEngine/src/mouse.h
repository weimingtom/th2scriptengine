...
extern void MUS_GetMouseDragPos( int button, int *mx, int *my );
...
extern void MUS_SetMouseRectAdd( int lno,int no, int rect_no, int sx, int sy, int w, int h,int flag );
extern BOOL MUS_GetMouseRect( int lno,int no, int *sx, int *sy, int *w, int *h );
...
extern void MUS_SetMouseRect_Disp( int lno, int gno );
extern void MUS_ResetMouseRect_Disp( int gno );
