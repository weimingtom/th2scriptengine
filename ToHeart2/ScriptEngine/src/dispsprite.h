...
extern BOOL SPR_CopySprite( int ani_no1,  int ani_no2, TCHAR *tfname=NULL, int viv=256, int r=128, int g=128, int b=128 );
extern BOOL SPR_LoadSprite( int ani_no, TCHAR *fname, TCHAR *tfname=NULL, int viv=256 );
extern BOOL SPR_LoadBmpSprite( int ani_no, TCHAR *fname, int nuki, TCHAR *tfname=NULL, int viv=256 );
