...
void SetMenuStr( HWND hwnd, int id, TCHAR *str )
{
...
void SetNewMenuStr( HWND hwnd, int id, int new_id, TCHAR *str )
{
	HMENU	hMenu  = GetMenu( hwnd );
...
void InsertMenuStr( HWND hwnd, int ins_id, int id, TCHAR *str )
{
	HMENU	hMenu  = GetMenu( hwnd );
...
void ResetMenu( HWND hwnd, int id, TCHAR *str )
{
	HMENU	hMenu  = GetMenu( hwnd );
