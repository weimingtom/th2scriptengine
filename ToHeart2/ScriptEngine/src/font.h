...
extern void FNT_SetPackDir( TCHAR *pac_dir );
...
extern void FNT_TextOutStr( HWND hwnd, HFONT hFont, HBITMAP hbmp, int x, int y, TCHAR *str );
...
extern void FNT_DrawText( void *dest, int draw_mode, int dest_x, int dest_y, int pich_w, int pich_h, TCHAR *str, int fsize, RECT *clip, int r, int g, int b, int alph, int kage );
