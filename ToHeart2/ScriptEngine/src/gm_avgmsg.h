...
#if 0
#define DEF_NAME_L		"河野"
#define DEF_NAME_LK		"こうの"
#define DEF_NAME_F		"貴明"
#define DEF_NAME_FK		"たかあき"
#define DEF_NAME_NN		"たか"
#define DEF_NAME_NNK	"タカ"
#else
//TODO:防止因为乱码而无法通过字符检查
#define DEF_NAME_L		"壨栰"
#define DEF_NAME_LK		"偙偆偺"
#define DEF_NAME_F		"婱柧"
#define DEF_NAME_FK		"偨偐偁偒"
#define DEF_NAME_NN		"偨偐"
#define DEF_NAME_NNK	"僞僇"
#endif
...
extern void AVG_SetNovelMessage( TCHAR *str, int add_flag );
extern void AVG_AddNovelMessage( TCHAR *str, int cr );
...
extern void AVG_SetText( int txt_no, TCHAR *str );
...
extern void AVG_SetMessage( int char_no, TCHAR *str, int type, int add_flag, int dy, int font );
extern void AVG_AddMessage( int char_no, TCHAR *str, int cr, int add_flag );
...
extern void AVG_SetSelectMessage( TCHAR *mes, int game_flag_no, int game_flag_value, int mes_wait );
extern void AVG_SetSelectMessageEx( TCHAR *mes, TCHAR *sno, int game_flag_no, int game_flag_value );
...
extern TCHAR *AVG_WaitSelectEx( void );
