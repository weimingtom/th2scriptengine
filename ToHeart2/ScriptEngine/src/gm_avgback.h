...
extern void AVG_LoadBmp( int bno, int bmp_bit, TCHAR *fname, int layer, int nuki, int tone_type, TCHAR *tfname, int viv, int bright, TCHAR *pack );
extern void AVG_LoadBmpAnime( int s_bno, int bmp_bit, TCHAR *fname, int loop, int layer, int nuki );
...
extern void AVG_SetAvi( int avino, int bno, int w, int h, TCHAR *fname );
