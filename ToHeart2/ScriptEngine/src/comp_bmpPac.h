...
extern int  PAC_PackFileMovie_Open( TCHAR *PackFname );
...
extern BOOL PAC_PackFileMovie_Read( int move_no, void *dest, int draw_mode, int bai, int frame, int skip=1 );
extern int  LZS_DecodeMemoryBmpTbl_DWORD( RGB32 *dst, char *src, int file_size, int sabun, int bai, int r, int g, int b );
extern int  LZS_DecodeMemoryBmpTbl_3BYTE( char *dst, char *src, int file_size, int sabun, int bai, int r, int g, int b );
extern int  LZS_DecodeMemoryBmpTbl_WORD(  WORD *dst, char *src, int file_size, int sabun, int bai, int r, int g, int b );
extern int  LZS_DecodeMemoryBmpTbl_BYTE( char *dst, RGB32 *tbl, char *src, int file_size, int sabun );
