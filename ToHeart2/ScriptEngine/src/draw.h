...
extern const char MeshTable[16][4];
extern WORD MeshFadePatern[17];
extern void DRW_SetRandMesh(void);
...
#define DRW_WAP(WAP,CNT)	(DRW_WAP2|(((WAP)|((CNT)<<8))<<16))	
#define WAP_PARAM(TYP,CNT)	(TYP|((CNT)<<16))	
...
extern BOOL DRW_ChangeBMP_B2H( BMP_H *dest,  BMP_BT *src );
extern BOOL DRW_ChangeBMP_B2F( BMP_F *dest,  BMP_BT *src );
extern BOOL DRW_ChangeBMP_B2T( BMP_T *dest,  BMP_BT *src );
extern BOOL DRW_ChangeBMP_H2B( BMP_BT *dest, BMP_H *src );
extern BOOL DRW_ChangeBMP_H2F( BMP_F *dest,  BMP_H *src );
extern BOOL DRW_ChangeBMP_H2T( BMP_T *dest,  BMP_H *src, int alph );
extern BOOL DRW_ChangeBMP_F2B( BMP_BT *dest, BMP_F *src );
extern BOOL DRW_ChangeBMP_F2H( BMP_H *dest,  BMP_F *src );
extern BOOL DRW_ChangeBMP_F2T( BMP_T *dest,  BMP_F *src );
extern BOOL DRW_ChangeBMP_T2B( BMP_BT *dest, BMP_T *src );
extern BOOL DRW_ChangeBMP_T2H( BMP_H *dest,  BMP_T *src, int alph );
extern BOOL DRW_ChangeBMP_T2F( BMP_F *dest,  BMP_T *src );
extern BOOL DRW_InitDigit( HINSTANCE hinst, TCHAR *bitmap );
...
extern void DRW_DrawBMP3( HWND hwnd, HBITMAP hbmp, int dx, int dy, int dw, int dh, int sx, int sy, int sw, int sh );
