...
extern void BMP_SetPackDir( TCHAR *pac_dir );
extern TCHAR *BMP_GetPackDir( void );
...
extern BOOL BMP_CheckFile( TCHAR *fname);
extern BOOL BMP_PalLoad( RGB32 *pal, char *fname);
extern BOOL BMP_PalLoad_BT( BMP_BT *bmp_b, TCHAR *fname);
extern BOOL BMP_PalSave( RGB32 *pal, TCHAR *fname);
extern BOOL BMP_PalSave_BT( BMP_BT *bmp_b, TCHAR *fname);
extern BOOL BMP_SetTonecurve_T( BMP_T *bmp_t, TCHAR *fname, int viv);
extern BOOL BMP_SetTonecurve_F( BMP_F *bmp_f, TCHAR *fname, int viv);
extern BOOL BMP_SetTonecurve_H( BMP_H *bmp_h, TCHAR *fname, int viv);
extern BOOL BMP_SetTonecurve_BT( BMP_BT *bmp_bt, TCHAR *fname, int viv);
extern BOOL BMP_LoadBMP_X2X( TCHAR *fname, BMP_SET *bmp_set, TCHAR *pack=NULL);
extern BOOL BMP_LoadBMP_X2T( TCHAR *fname, BMP_T *bmp_t, POINT *pos, POINT *size, int *alp_flag, TCHAR *pack=NULL);
extern BOOL BMP_LoadBMP_X2F( TCHAR *fname, BMP_F *bmp_f, POINT *pos, POINT *size, TCHAR *pack=NULL);
extern BOOL BMP_LoadBMP_X2H( TCHAR *fname, BMP_H *bmp_h, POINT *pos, POINT *size, int *alp_flag, TCHAR *pack=NULL);
extern BOOL BMP_LoadBMP_X2B( TCHAR *fname, BMP_BT *bmp_bt, POINT *pos, POINT *size, int *alp_flag, TCHAR *pack=NULL);
extern BOOL BMP_CheckBMPBpp( TCHAR *fname);
extern BOOL BMP_CheckBMPBpp2( TCHAR *fname);
extern BOOL BMP_LoadBMP_T2T( TCHAR *fname, BMP_T *bmp_t );
extern BOOL BMP_LoadBMP_F2T( TCHAR *fname, BMP_T *bmp_t );
extern BOOL BMP_LoadBMP_B2T( TCHAR *fname, BMP_T *bmp_t );
extern BOOL BMP_LoadBMP_F2F( TCHAR *fname, BMP_F *bmp_f );
extern BOOL BMP_LoadBMP_B2F( TCHAR *fname, BMP_F *bmp_f );
extern BOOL BMP_LoadBMP_T2H( TCHAR *fname, BMP_H *bmp_h );
extern BOOL BMP_LoadBMP_F2H( TCHAR *fname, BMP_H *bmp_h );
extern BOOL BMP_LoadBMP_H2H( TCHAR *fname, BMP_H *bmp_h);
extern BOOL BMP_LoadBMP_B2H( TCHAR *fname, BMP_H *bmp_h);
extern BOOL BMP_LoadBMP_B2B( TCHAR *fname, BMP_BT *bmp_bt );
extern BOOL BMP_LoadBMP_B2B_Key( TCHAR *fname, BMP_BT *bmp_bt, int *key);
...
extern int BMP_SaveBmp_T( TCHAR *fname, BMP_T *bmp_t );
extern int BMP_SaveBmp_F( TCHAR *fname, BMP_F *bmp_f );
extern int BMP_SaveBmp_H( char *fname, BMP_H *bmp_h );
extern int BMP_SaveBmp_B( TCHAR *fname, BMP_BT *bmp_bt );
...
extern int BMP_MakeAlphaFF2T( TCHAR *bfname, TCHAR *afname, TCHAR *tfname, int alp_flag, int alp_end, int alp250, int CutSave );
extern int BMP_MakeAlphaBB2BA( TCHAR *bfname, TCHAR *afname, TCHAR *tfname, int alp250, int CutSave );
