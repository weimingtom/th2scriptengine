...
extern void SetMenuStr( HWND hwnd, int id, TCHAR *str );
extern void SetNewMenuStr( HWND hwnd, int id, int new_id, TCHAR *str );
extern void InsertMenuStr( HWND hwnd, int ins_id, int id, TCHAR *str );
extern void ResetMenu( HWND hwnd, int id, TCHAR *str );
